  ...
  return (
    <div className='w-[100vw] bg-slate-100 px-5 pb-4 mt-5'>
        <div className='xl:flex'>
            <div className=' p-3 xl:w-[50%] xl:flex flex-col items-center justify-center '>
                <h3 className='2xl:text-4xl'>SAS TECHNOLOGY</h3>
                <p className='lg:text-lg md:text-lg 2xl:text-2xl xl:text-xl roboto'>Partner in Digital Transformation </p>
            ...
            <div className='grid sm:grid-cols-2 xl:grid-cols-[25%,35%,40%]  2xl:w-[50%] pt-2'>
                ...
                <h5 className='lg:p-2 raleway'>Contact Us</h5>
               <p className='lg:text-lg md:text-lg roboto'>
